...
from Models.Formers.FEDformer.FourierCorrelation import FourierBlock, FourierCrossAttention
from Models.Formers.FEDformer.MultiWaveletCorrelation import MultiWaveletCross, MultiWaveletTransform
from Models.Formers.Layers.SelfAttention_Family import FullAttention, ProbAttention
...
from Models.Formers.Autoformer.Autoformer_EncDec import Encoder, Decoder, EncoderLayer, DecoderLayer, my_Layernorm, series_decomp, series_decomp_multi
import math
import numpy as np
    ...
    def __init__(self, configs):
        ...
        if configs.version == 'Wavelets':
            ...
            decoder_cross_att = FourierCrossAttention(in_channels=configs.d_model,
                                                      ...
                                                      mode_select_method=configs.mode_select)
        # Encoder
        enc_modes = int(min(configs.modes, configs.past_history//2))
        dec_modes = int(min(configs.modes, (configs.past_history//2+configs.forecast_horizon)//2))
