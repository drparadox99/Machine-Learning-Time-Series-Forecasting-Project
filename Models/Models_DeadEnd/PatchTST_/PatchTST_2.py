#https://github.com/Lalf-Klein/patchtst_single_channel/blob/main/PatchTST_single_channel_exp.ipynb?source=post_page-----f375699f7b91--------------------------------
...
#Modify output for a multivariate output instead of univariate input
