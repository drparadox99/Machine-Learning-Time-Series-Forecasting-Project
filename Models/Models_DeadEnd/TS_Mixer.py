...
class RevIN(nn.Module):
    def __init__(self, num_features: int, eps=1e-5, affine=False, subtract_last=True):
        """
...
class Backbone(nn.Module):
    def __init__(self, configs):
        ...
        self.seq_len = seq_len = configs.past_history
        self.pred_len = pred_len = configs.forecast_horizon
        self.enc_in = enc_in = configs.num_series
